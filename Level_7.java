...
public class Level_7 extends AppCompatActivity { //
    ...
    static int[] forobst1 = {10,5,6,7,12};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GameScreen_7 gameScreen = (GameScreen_7) findViewById(R.id.game_screen_7); //////
        gameScreen.counter = 0;
        gameScreen.loose = false;
        final int moster_square = 1;
        final int pit_square = 9;
        final int character_square = 11;
        ...
        final Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.drawable.level7); //
