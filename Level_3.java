...
public class Level_3 extends AppCompatActivity { //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (! MainMenu.sPref.contains("Level_3")) {//
            ed.putBoolean("Level_3", false);//
            ed.commit();
        }
        Log.d("12",String.valueOf(MainMenu.sPref.getBoolean("Level_2",true)));



        final boolean started = false;
        final ArrayList<Integer> way = new ArrayList<>();
        final GameScreen_3 gameScreen = (GameScreen_3) findViewById(R.id.game_screen_3); //////
        gameScreen.counter = 0;
        gameScreen.loose = false;
        final int moster_square =11;
        final int pit_square = 7;
        final int character_square = 13;
        ...
        final Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.drawable.level3); //
