...
public class Level_5 extends AppCompatActivity { //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GameScreen_5 gameScreen = (GameScreen_5) findViewById(R.id.game_screen_5); //////
        ...
        final Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.drawable.level5); //
