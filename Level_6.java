...
public class Level_6 extends AppCompatActivity { //
    ...
    static int[] forobst1 = {21,3,8,13,18};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GameScreen_6 gameScreen = (GameScreen_6) findViewById(R.id.game_screen_6); //////
        gameScreen.counter = 0;
        gameScreen.loose = false;
        final int moster_square = 4;
        final int pit_square = 5;
        final int character_square = 20;
        ...
        final Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.drawable.level6); //
