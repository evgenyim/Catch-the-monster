...
public class Level_8 extends AppCompatActivity { //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GameScreen_8 gameScreen = (GameScreen_8) findViewById(R.id.game_screen_8); //////
        gameScreen.counter = 0;
        gameScreen.loose = false;
        final int moster_square = 0;
        final int pit_square = 8;
        final int character_square = 18;
