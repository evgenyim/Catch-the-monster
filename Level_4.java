...
public class Level_4 extends AppCompatActivity { //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GameScreen_4 gameScreen = (GameScreen_4) findViewById(R.id.game_screen_4); //////
        ...
        final Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.drawable.level4); //
